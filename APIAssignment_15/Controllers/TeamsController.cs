...
using APIAssignment_15.Data;
using APIAssignment_15.Models;

namespace APIAssignment_15.Controllers
{
    public class TeamsController : ApiController
    {
        private TeamServiceDbContext db = new TeamServiceDbContext();
